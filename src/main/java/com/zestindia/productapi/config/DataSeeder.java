 ...
 * immediately testable via Swagger/Postman. The assignment spec does not
 * define a registration endpoint, so accounts are provisioned here instead.
 * Replace with a proper registration flow / IdP integration in production.
 */
@Component
