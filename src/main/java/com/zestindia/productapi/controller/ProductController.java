...
public class ProductController {
	...
	public ResponseEntity<PagedResponse<ProductResponse>> getAll(@RequestParam(defaultValue = "0") int page,
	...
	public ResponseEntity<PagedResponse<ItemResponse>> getItems(@PathVariable Integer id,
	...
	public ResponseEntity<ItemResponse> addItem(@PathVariable Integer id, @Valid @RequestBody ItemRequest request) {
