...
public class GlobalExceptionHandler {
    ...
    /**
     * Safety net: catches raw DB-level unique constraint violations (e.g. a duplicate
     * username that slipped past the pre-check due to a race between two near-simultaneous
     * requests) and returns a clean 409 instead of leaking a 500 with a stack trace.
     */
